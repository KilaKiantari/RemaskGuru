...
//    ArrayList<String> xValues = new ArrayList<String>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ApiClient.services_get_grafik_progress.getGrafikProgress(id_tugas).enqueue(new Callback<ModelGrafik>() {
            @Override
            public void onResponse(Call<ModelGrafik> call, Response<ModelGrafik> response) {
                modelGrafik = response.body();
                Log.e("Response Search ", "Code : " + response.code());
                Integer sudah = response.body().getJml();
                Integer belum = response.body().getJmlbelum();
                if (sudah + belum == 0) {
            ...
            public void onFailure(Call<ModelGrafik> call, Throwable t) {
...
//        ApiClient.services_get_grafik_progress_belum.getGrafikProgressBelum(id_tugas).enqueue(new Callback<ModelGrafik>() {
//            @Override
//            public void onResponse(Call<ModelGrafik> call, Response<ModelGrafik> response) {
//                modelGrafik = response.body();
//                Log.e("Response Search ", "Code : " + response.code());
