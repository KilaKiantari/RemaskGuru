...
import com.example.asus_desktop.remaskguru.Menu2.SiswaYangMasukGrup;
...
public class JoinSiswaGrupAdapter extends RecyclerView.Adapter<JoinSiswaGrupAdapter.MahasiswaViewHolder>{
    private String namagroup;
    private String id_tugas;

    public JoinSiswaGrupAdapter.MahasiswaViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.card_view_join, parent, false);
        return new JoinSiswaGrupAdapter.MahasiswaViewHolder(view);
    }
    ...
    public JoinSiswaGrupAdapter(Context mContext,ArrayList<Result> results) {
    ...
    public void onBindViewHolder(final JoinSiswaGrupAdapter.MahasiswaViewHolder holder, final int position) {
    ...
    private void showPopupMenu(View view) {
        ...
        popup.setOnMenuItemClickListener(new JoinSiswaGrupAdapter.MyMenuItemClickListener());
        popup.show();
        ...
        public boolean onMenuItemClick(MenuItem menuItem) {
            switch (menuItem.getItemId()) {
                case R.id.action_lihat_join:
                    Intent intent = new Intent(mContext, SiswaYangMasukGrup.class);
